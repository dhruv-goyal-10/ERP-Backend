...
urlpatterns = [
    path('profiledetails/', SProfileDetails.as_view(),
    ...
    path('studentoverallattendance/', StudentOverallAttendance.as_view(),
         name='StudentOverallAttendance'),
    path('studentsubjectattendance/<str:subject_code>/<str:month>/',
