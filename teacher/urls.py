...
urlpatterns = [
    ...
    path('studentinclass/<str:classid>/',
         StudentInClass.as_view(), name='studentclassfilter'),
    path('studentinclass/<str:classid>/<str:feedback>/',
         StudentInClass.as_view(), name='studentclassfeedback'),

    path('teachersofclass/<str:classid>/',
         TeacherOfClass.as_view(), name='teacherclassfilter'),
